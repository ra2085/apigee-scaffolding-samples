...
var supportedVerbs = ['GET','POST','PUT','DELETE','PATCH'];//TODO: HEAD and OPTIONS

module.exports = class extends Generator {

    async prompting() {

      this.log(require('yosay')('Scaffolding tool for APIs deployed in Apigee Edge'));
    ...
    createMock(){
  		if(this.promptAnswers.createMock){
  			...
  			let hostedTarget = doc.createElement('HostedTarget');
  			target[0].appendChild(hostedTarget);
	...
	copyNodeResources(){
		if(this.promptAnswers.createMock){
			fsy.copySync(this.promptAnswers.name + '/node', this.promptAnswers.name + '/apiproxy/resources/hosted');
